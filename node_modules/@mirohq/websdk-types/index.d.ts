...
declare module "@mirohq/websdk-types/experimental/api/commands" {
    import { CommandType } from "@mirohq/websdk-types/stable/api/commands";
    export type ExperimentalCommandType = CommandType | 'CUSTOM_ACTION_REGISTER' | 'CUSTOM_ACTION_DEREGISTER' | 'FIND_EMPTY_SPACE' | 'GET_VOTING_RESULTS' | 'HISTORY_CAN_UNDO' | 'HISTORY_UNDO' | 'HISTORY_CAN_REDO' | 'HISTORY_REDO';
}
...
declare module "@mirohq/websdk-types/core/features/base.client" {
    ...
    export const baseClientFeature: <Ctx extends Context, Item extends InferItemFromContext<Ctx> = InferItemFromContext<Ctx>>(ctx: Ctx) => BaseFeature<Item>;
}
...
declare module "@mirohq/websdk-types/stable/features/board" {
    ...
    export const boardFeature: <T extends Context>(ctx: T) => {
        ...
        getAppData<K extends string | undefined = undefined>(key?: K): Promise<K extends string ? AppDataValue : AppData>;
...
declare module "@mirohq/websdk-types/experimental/client/index" {
    ...
    export const experimentalSdkClientSchema: import("@mirohq/websdk-types/core/builder/types").SdkClientBuilder<string, import("@mirohq/websdk-types/stable/index").Connector | import("@mirohq/websdk-types/stable/index").Card | import("@mirohq/websdk-types/stable/index").AppCard | import("@mirohq/websdk-types/stable/index").Tag | import("@mirohq/websdk-types/stable/index").Embed | import("@mirohq/websdk-types/stable/index").Image | import("@mirohq/websdk-types/stable/index").Preview | import("@mirohq/websdk-types/stable/index").StickyNote | import("@mirohq/websdk-types/stable/index").Text | import("@mirohq/websdk-types/experimental/features/widgets/mindmapNode").MindmapNode | Shape | Group | Frame, {
        ...
        createFrame: ((props?: {
            ...
            relativeTo?: import("@mirohq/websdk-types/core/builder/types").DeepPartial<import("@mirohq/websdk-types/stable/index").RelativeTo> | undefined;
            ...
            showContent?: import("@mirohq/websdk-types/core/builder/types").DeepPartial<boolean> | undefined;
            childrenIds?: string[] | undefined;
        } | undefined) => Promise<import("@mirohq/websdk-types/stable/index").Frame>);
        createGroup: ((props: {
        ...
        createShape: ((props?: {
            style?: import("@mirohq/websdk-types/core/builder/types").DeepPartial<import("@mirohq/websdk-types/stable/index").ShapeStyle> | undefined;
            ...
            readonly width?: number | undefined;
            readonly height?: number | undefined;
            shape?: import("@mirohq/websdk-types/core/builder/types").DeepPartial<"circle" | "triangle" | "rectangle" | "wedge_round_rectangle_callout" | "round_rectangle" | "rhombus" | "parallelogram" | "star" | "right_arrow" | "left_arrow" | "pentagon" | "hexagon" | "octagon" | "trapezoid" | "flow_chart_predefined_process" | "left_right_arrow" | "cloud" | "left_brace" | "right_brace" | "cross" | "can" | import("@mirohq/websdk-types/stable/index").ShapeType> | undefined;
            linkedTo?: import("@mirohq/websdk-types/core/builder/types").DeepPartial<string | undefined>;
            readonly connectorIds?: import("@mirohq/websdk-types/core/builder/types").DeepPartial<string[] | undefined>;
            rotation?: number | undefined;
            content?: string | undefined;
        } | undefined) => Promise<import("@mirohq/websdk-types/stable/index").Shape>);
        ...
        get: <F extends import("@mirohq/websdk-types/core/builder/types").QueryFilter<import("@mirohq/websdk-types/stable/index").Connector | import("@mirohq/websdk-types/stable/index").Card | import("@mirohq/websdk-types/stable/index").AppCard | import("@mirohq/websdk-types/stable/index").Tag | import("@mirohq/websdk-types/stable/index").Embed | import("@mirohq/websdk-types/stable/index").Image | import("@mirohq/websdk-types/stable/index").Preview | import("@mirohq/websdk-types/stable/index").Shape | import("@mirohq/websdk-types/stable/index").StickyNote | import("@mirohq/websdk-types/stable/index").Text | import("@mirohq/websdk-types/stable/index").Frame | import("@mirohq/websdk-types/stable/index").Group>>(filter?: F | undefined) => Promise<import("@mirohq/websdk-types/core/builder/types").QueryReturn<import("@mirohq/websdk-types/stable/index").Connector | import("@mirohq/websdk-types/stable/index").Card | import("@mirohq/websdk-types/stable/index").AppCard | import("@mirohq/websdk-types/stable/index").Tag | import("@mirohq/websdk-types/stable/index").Embed | import("@mirohq/websdk-types/stable/index").Image | import("@mirohq/websdk-types/stable/index").Preview | import("@mirohq/websdk-types/stable/index").Shape | import("@mirohq/websdk-types/stable/index").StickyNote | import("@mirohq/websdk-types/stable/index").Text | import("@mirohq/websdk-types/stable/index").Frame | import("@mirohq/websdk-types/stable/index").Group, F>>;
        getById: (id: string) => Promise<import("@mirohq/websdk-types/stable/index").Connector | import("@mirohq/websdk-types/stable/index").Unsupported | import("@mirohq/websdk-types/stable/index").Card | import("@mirohq/websdk-types/stable/index").AppCard | import("@mirohq/websdk-types/stable/index").Tag | import("@mirohq/websdk-types/stable/index").Embed | import("@mirohq/websdk-types/stable/index").Image | import("@mirohq/websdk-types/stable/index").Preview | import("@mirohq/websdk-types/stable/index").Shape | import("@mirohq/websdk-types/stable/index").StickyNote | import("@mirohq/websdk-types/stable/index").Text | import("@mirohq/websdk-types/stable/index").Frame | import("@mirohq/websdk-types/stable/index").Group>;
        getSelection: () => Promise<(import("@mirohq/websdk-types/stable/index").Connector | import("@mirohq/websdk-types/stable/index").Unsupported | import("@mirohq/websdk-types/stable/index").Card | import("@mirohq/websdk-types/stable/index").AppCard | import("@mirohq/websdk-types/stable/index").Tag | import("@mirohq/websdk-types/stable/index").Embed | import("@mirohq/websdk-types/stable/index").Image | import("@mirohq/websdk-types/stable/index").Preview | import("@mirohq/websdk-types/stable/index").Shape | import("@mirohq/websdk-types/stable/index").StickyNote | import("@mirohq/websdk-types/stable/index").Text | import("@mirohq/websdk-types/stable/index").Frame | import("@mirohq/websdk-types/stable/index").Group)[]>;
        select: <F_1 extends import("@mirohq/websdk-types/core/builder/types").QueryFilter<import("@mirohq/websdk-types/stable/index").Connector | import("@mirohq/websdk-types/stable/index").Card | import("@mirohq/websdk-types/stable/index").AppCard | import("@mirohq/websdk-types/stable/index").Tag | import("@mirohq/websdk-types/stable/index").Embed | import("@mirohq/websdk-types/stable/index").Image | import("@mirohq/websdk-types/stable/index").Preview | import("@mirohq/websdk-types/stable/index").Shape | import("@mirohq/websdk-types/stable/index").StickyNote | import("@mirohq/websdk-types/stable/index").Text | import("@mirohq/websdk-types/stable/index").Frame | import("@mirohq/websdk-types/stable/index").Group>>(filter?: F_1 | undefined) => Promise<import("@mirohq/websdk-types/core/builder/types").QueryReturn<import("@mirohq/websdk-types/stable/index").Connector | import("@mirohq/websdk-types/stable/index").Card | import("@mirohq/websdk-types/stable/index").AppCard | import("@mirohq/websdk-types/stable/index").Tag | import("@mirohq/websdk-types/stable/index").Embed | import("@mirohq/websdk-types/stable/index").Image | import("@mirohq/websdk-types/stable/index").Preview | import("@mirohq/websdk-types/stable/index").Shape | import("@mirohq/websdk-types/stable/index").StickyNote | import("@mirohq/websdk-types/stable/index").Text | import("@mirohq/websdk-types/stable/index").Frame | import("@mirohq/websdk-types/stable/index").Group, F_1>>;
        deselect: <F_2 extends import("@mirohq/websdk-types/core/builder/types").QueryFilter<import("@mirohq/websdk-types/stable/index").Connector | import("@mirohq/websdk-types/stable/index").Card | import("@mirohq/websdk-types/stable/index").AppCard | import("@mirohq/websdk-types/stable/index").Tag | import("@mirohq/websdk-types/stable/index").Embed | import("@mirohq/websdk-types/stable/index").Image | import("@mirohq/websdk-types/stable/index").Preview | import("@mirohq/websdk-types/stable/index").Shape | import("@mirohq/websdk-types/stable/index").StickyNote | import("@mirohq/websdk-types/stable/index").Text | import("@mirohq/websdk-types/stable/index").Frame | import("@mirohq/websdk-types/stable/index").Group>>(filter?: F_2 | undefined) => Promise<import("@mirohq/websdk-types/core/builder/types").QueryReturn<import("@mirohq/websdk-types/stable/index").Connector | import("@mirohq/websdk-types/stable/index").Card | import("@mirohq/websdk-types/stable/index").AppCard | import("@mirohq/websdk-types/stable/index").Tag | import("@mirohq/websdk-types/stable/index").Embed | import("@mirohq/websdk-types/stable/index").Image | import("@mirohq/websdk-types/stable/index").Preview | import("@mirohq/websdk-types/stable/index").Shape | import("@mirohq/websdk-types/stable/index").StickyNote | import("@mirohq/websdk-types/stable/index").Text | import("@mirohq/websdk-types/stable/index").Frame | import("@mirohq/websdk-types/stable/index").Group, F_2>>;
        ...
        getMetadata: <K extends string | undefined = undefined>(item: import("@mirohq/websdk-types/core/features/widgets/base").BaseItem, key?: K | undefined) => Promise<K extends string ? import("@mirohq/websdk-types/stable/index").Json : import("@mirohq/websdk-types/stable/index").AppData>;
        setMetadata: <D extends import("@mirohq/websdk-types/stable/index").AppData>(item: import("@mirohq/websdk-types/core/features/widgets/base").BaseItem, key: string, value: import("@mirohq/websdk-types/stable/index").Json) => Promise<D>;
        goToLink: (item: import("@mirohq/websdk-types/core/features/widgets/base").BaseItem) => Promise<boolean>;
        bringToFront: (items: import("@mirohq/websdk-types/stable/index").OneOrMany<import("@mirohq/websdk-types/core/features/widgets/base").BaseItem>) => Promise<void>;
        sendToBack: (items: import("@mirohq/websdk-types/stable/index").OneOrMany<import("@mirohq/websdk-types/core/features/widgets/base").BaseItem>) => Promise<void>;
        bringInFrontOf: (items: import("@mirohq/websdk-types/stable/index").OneOrMany<import("@mirohq/websdk-types/core/features/widgets/base").BaseItem>, target: import("@mirohq/websdk-types/core/features/widgets/base").BaseItem) => Promise<void>;
        sendBehindOf: (items: import("@mirohq/websdk-types/stable/index").OneOrMany<import("@mirohq/websdk-types/core/features/widgets/base").BaseItem>, target: import("@mirohq/websdk-types/core/features/widgets/base").BaseItem) => Promise<void>;
        ...
        group: (props: import("@mirohq/websdk-types/stable/index").CreateGroupProps) => Promise<import("@mirohq/websdk-types/stable/index").Group>;
        remove: (item: import("@mirohq/websdk-types/core/builder/types").BaseItem) => Promise<void>;
        createAppCard: (props?: {
            style?: import("@mirohq/websdk-types/core/builder/types").DeepPartial<import("@mirohq/websdk-types/stable/index").CardStyle> | undefined;
            title?: string | undefined;
            readonly type?: "app_card" | undefined;
            x?: number | undefined;
            y?: number | undefined;
            status?: import("@mirohq/websdk-types/core/builder/types").DeepPartial<import("@mirohq/websdk-types/stable/index").AppCardStatus> | undefined;
            readonly id?: string | undefined;
            origin?: "center" | undefined;
            relativeTo?: import("@mirohq/websdk-types/core/builder/types").DeepPartial<import("@mirohq/websdk-types/stable/index").RelativeTo> | undefined;
            readonly parentId?: import("@mirohq/websdk-types/core/builder/types").DeepPartial<string | null> | undefined;
            ...
            fields?: import("@mirohq/websdk-types/core/builder/types").DeepPartial<import("@mirohq/websdk-types/stable/index").CardField[] | undefined>;
            readonly owned?: import("@mirohq/websdk-types/core/builder/types").DeepPartial<boolean> | undefined;
        } | undefined) => Promise<import("@mirohq/websdk-types/stable/index").AppCard>;
        createCard: (props?: {
            style?: import("@mirohq/websdk-types/core/builder/types").DeepPartial<import("@mirohq/websdk-types/stable/index").CardStyle> | undefined;
            title?: string | undefined;
            ...
            startDate?: import("@mirohq/websdk-types/core/builder/types").DeepPartial<string | undefined>;
            assignee?: import("@mirohq/websdk-types/core/builder/types").DeepPartial<import("@mirohq/websdk-types/stable/index").CardAssignee | undefined>;
            taskStatus?: import("@mirohq/websdk-types/core/builder/types").DeepPartial<import("@mirohq/websdk-types/stable/index").CardTaskStatus> | undefined;
            tagIds?: string[] | undefined;
            fields?: import("@mirohq/websdk-types/core/builder/types").DeepPartial<import("@mirohq/websdk-types/stable/index").CardField[] | undefined>;
        } | undefined) => Promise<import("@mirohq/websdk-types/stable/index").Card>;
        createConnector: (props: {
            style?: import("@mirohq/websdk-types/core/builder/types").DeepPartial<import("@mirohq/websdk-types/stable/index").ConnectorStyle> | undefined;
            ...
            readonly width?: number | undefined;
            readonly height?: number | undefined;
            shape?: import("@mirohq/websdk-types/core/builder/types").DeepPartial<import("@mirohq/websdk-types/stable/index").ConnectorShape> | undefined;
            ...
            captions?: import("@mirohq/websdk-types/core/builder/types").DeepPartial<import("@mirohq/websdk-types/stable/index").ConnectorCaption[] | undefined>;
        ...
        createEmbed: (props: {
            ...
            mode?: import("@mirohq/websdk-types/core/builder/types").DeepPartial<import("@mirohq/websdk-types/stable/index").EmbedMode> | undefined;
        }) => Promise<import("@mirohq/websdk-types/stable/index").Embed>;
        createImage: (props: import("@mirohq/websdk-types/stable/index").ImageProps) => Promise<import("@mirohq/websdk-types/stable/index").Image>;
        createPreview: (props: import("@mirohq/websdk-types/stable/index").PreviewProps) => Promise<import("@mirohq/websdk-types/stable/index").Preview>;
        createStickyNote: (props?: {
            style?: import("@mirohq/websdk-types/core/builder/types").DeepPartial<import("@mirohq/websdk-types/stable/index").StickyNoteStyle> | undefined;
            ...
            width?: number | undefined;
            height?: number | undefined;
            shape?: import("@mirohq/websdk-types/core/builder/types").DeepPartial<import("@mirohq/websdk-types/stable/index").StickyNoteShape> | undefined;
            linkedTo?: import("@mirohq/websdk-types/core/builder/types").DeepPartial<string | undefined>;
            readonly connectorIds?: import("@mirohq/websdk-types/core/builder/types").DeepPartial<string[] | undefined>;
            tagIds?: string[] | undefined;
            content?: string | undefined;
        } | undefined) => Promise<import("@mirohq/websdk-types/stable/index").StickyNote>;
        createText: (props?: {
            style?: import("@mirohq/websdk-types/core/builder/types").DeepPartial<import("@mirohq/websdk-types/stable/index").TextStyle> | undefined;
            ...
            rotation?: number | undefined;
            content?: string | undefined;
        } | undefined) => Promise<import("@mirohq/websdk-types/stable/index").Text>;
        createTag: (props?: {
            title?: string | undefined;
        ...
        } | undefined) => Promise<import("@mirohq/websdk-types/stable/index").Tag>;
        ...
        getIdToken: () => Promise<string>;
        canUse: (feature: import("@mirohq/websdk-types/stable/index").BoardFeature) => Promise<boolean>;
        getAppData: <K_1 extends string | undefined = undefined>(key?: K_1 | undefined) => Promise<K_1 extends string ? import("@mirohq/websdk-types/stable/index").Json : import("@mirohq/websdk-types/stable/index").AppData>;
        setAppData: <D_1 extends import("@mirohq/websdk-types/stable/index").AppData>(key: string, value: import("@mirohq/websdk-types/stable/index").Json) => Promise<D_1>;
        ...
        findEmptySpace: (dimensions: import("@mirohq/websdk-types/stable/index").Rect & {
...
declare module "@mirohq/websdk-types/stable/client/index" {
    ...
    export const baseSdkClientSchema: import("@mirohq/websdk-types/core/builder/types").SdkClientBuilder<string, Connector | Card | AppCard | Tag | Embed | Image | Preview | Shape | StickyNote | Text | Frame | Group, import("@mirohq/websdk-types/core/builder/types").BaseFeature<Connector | Card | AppCard | Tag | Embed | Image | Preview | Shape | StickyNote | Text | Frame | Group> & Omit<{
        ...
        getIdToken(): Promise<string>;
        canUse(feature: import("@mirohq/websdk-types/stable/index").BoardFeature): Promise<boolean>;
        getAppData<K extends string | undefined = undefined>(key?: K | undefined): Promise<K extends string ? import("@mirohq/websdk-types/stable/index").Json : import("@mirohq/websdk-types/stable/index").AppData>;
        setAppData<D extends import("@mirohq/websdk-types/stable/index").AppData>(key: string, value: import("@mirohq/websdk-types/stable/index").Json): Promise<D>;
        setMetadata<D_1 extends import("@mirohq/websdk-types/stable/index").AppData>(item: import("@mirohq/websdk-types/core/features/widgets/base").BaseItem, key: string, value: import("@mirohq/websdk-types/stable/index").Json): Promise<D_1>;
        getMetadata<K_1 extends string | undefined = undefined>(item: import("@mirohq/websdk-types/core/features/widgets/base").BaseItem, key?: K_1 | undefined): Promise<K_1 extends string ? import("@mirohq/websdk-types/stable/index").Json : import("@mirohq/websdk-types/stable/index").AppData>;
        getUserInfo(): Promise<import("@mirohq/websdk-types/stable/index").UserInfo>;
        getOnlineUsers(): Promise<import("@mirohq/websdk-types/stable/index").OnlineUserInfo[]>;
        ...
        createShape: (props?: {
            ...
            readonly width?: number | undefined;
            readonly height?: number | undefined;
            shape?: import("@mirohq/websdk-types/core/builder/types").DeepPartial<"circle" | "triangle" | "rectangle" | "wedge_round_rectangle_callout" | "round_rectangle" | "rhombus" | "parallelogram" | "star" | "right_arrow" | "left_arrow" | "pentagon" | "hexagon" | "octagon" | "trapezoid" | "flow_chart_predefined_process" | "left_right_arrow" | "cloud" | "left_brace" | "right_brace" | "cross" | "can" | import("@mirohq/websdk-types/stable/features/widgets/shape").ShapeType> | undefined;
            linkedTo?: import("@mirohq/websdk-types/core/builder/types").DeepPartial<string | undefined>;
            readonly connectorIds?: import("@mirohq/websdk-types/core/builder/types").DeepPartial<string[] | undefined>;
            rotation?: number | undefined;
            content?: string | undefined;
    ...
    export const stableSdkClientSchema: import("@mirohq/websdk-types/core/builder/types").SdkClientBuilder<string, Connector | Card | AppCard | Tag | Embed | Image | Preview | Shape | StickyNote | Text | Frame | Group, {
        experimental: Readonly<{
            ...
            getById: (id: string) => Promise<Connector | import("@mirohq/websdk-types/stable/index").Unsupported | Card | AppCard | Tag | Embed | Image | Preview | StickyNote | Text | Frame | Group | import("@mirohq/websdk-types/experimental/features/widgets/mindmapNode").MindmapNode | ShapeExperimental>;
            getSelection: () => Promise<(Connector | import("@mirohq/websdk-types/stable/index").Unsupported | Card | AppCard | Tag | Embed | Image | Preview | StickyNote | Text | Frame | Group | import("@mirohq/websdk-types/experimental/features/widgets/mindmapNode").MindmapNode | ShapeExperimental)[]>;
