 ...
 */
export declare class CreateBoardSubscriptionRequest {
    /**
     ...
     */
    'status'?: string | (typeof CreateBoardSubscriptionRequest.StatusEnum)[keyof typeof CreateBoardSubscriptionRequest.StatusEnum];
    /** @ignore */
...
export declare namespace CreateBoardSubscriptionRequest {
    const StatusEnum: {
