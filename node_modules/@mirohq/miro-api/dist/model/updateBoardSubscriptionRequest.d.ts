 ...
 */
export declare class UpdateBoardSubscriptionRequest {
    /**
     ...
     */
    'status'?: string | (typeof UpdateBoardSubscriptionRequest.StatusEnum)[keyof typeof UpdateBoardSubscriptionRequest.StatusEnum];
    /** @ignore */
...
export declare namespace UpdateBoardSubscriptionRequest {
    const StatusEnum: {
