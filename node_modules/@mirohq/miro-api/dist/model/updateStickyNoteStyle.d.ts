 ...
 */
export declare class UpdateStickyNoteStyle {
    /**
     ...
     */
    'textAlignVertical'?: string | (typeof UpdateStickyNoteStyle.TextAlignVerticalEnum)[keyof typeof UpdateStickyNoteStyle.TextAlignVerticalEnum];
    /** @ignore */
...
export declare namespace UpdateStickyNoteStyle {
    const FillColorEnum: {
        readonly Gray: "gray";
